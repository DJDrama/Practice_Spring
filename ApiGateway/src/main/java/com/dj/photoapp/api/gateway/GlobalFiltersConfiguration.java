package com.dj.photoapp.api.gateway;
...
public class GlobalFiltersConfiguration {
	...
	// specifying order for filters (lower index for pre filter means high priority while lower index for post filter means low priority)
	@Order(1)
	@Bean
